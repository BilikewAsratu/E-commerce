    ...
    return (
        <div className='text-center'>
            ...
            <p className='text-gray-400 mt-3'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, quam quidem.
            </p>
            <form onSubmit={onSubmitHandler} className='wf-ull sm:w-1/2 flex items-center gap-3 mx-auto my-6 border pl-3'>
